...
public class TestController {
    ...
    public Result<ResultCache> testResultsCache() {
        ...
        LocalDateTime BTime = LocalDateTime.of(2023, 9, 5, 9, 43, 20);
        LocalDateTime ETime = LocalDateTime.of(2023, 9, 5, 10, 43, 20);
        DateTimeFormatter ofPattern = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");
        String bTime = ofPattern.format(BTime);
        String eTime = ofPattern.format(ETime);
